...
var UserSchema = new Schema({
  ...
  lastName: {
    ...
    trim: true,
    default: '',
    validate: [validateLocalStrategyProperty, 'Por favor, ingrese sus apellidos']
  },
  displayName: {
    type: String,
    trim: true
  ...
  email: {
    ...
    unique: true,
    default: '',
    validate: [validateLocalStrategyEmail, 'Por favor, ingrese un correo electrónico válido']
  },
  username: {
    type: String,
  ...
  password: {
    type: String,
    default: '',
    validate: [validateLocalStrategyPassword, 'La contraseña es insegura, por favor, intente con otra contraseña']
  },
  salt: {
    type: String
  },
